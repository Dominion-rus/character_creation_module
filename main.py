...
class Character:
    ...
    def attack(self):
        ...
        Returns:
            str: Строка сообщающая сколько урона нанес персонаж.
        """
    ...
    def defence(self):
        """Вычисляет сколько урона блокировал персонаж.
        ...
        Returns:
            str: Строка сообщающая сколько урона блокировал персонаж.
        """
...
def choice_char_class(char_name: str) -> Character:
    """Фунция для выбора класса персонажа.

    Args:
        char_name(str): Имя персонажа.

    Returns:
        Character(obj): Класс персонажа.
    """
...
def start_training(character: Character, char_name: str) -> str:
    """
    ...
    cmd_dict = {'attack': character.attack, 'defence': character.defence,
...
if __name__ == '__main__':
    ...
    print(start_training(char_class, char_name))